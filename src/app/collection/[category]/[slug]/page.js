      ...
      <main className="pt-24 pb-20 px-6 md:px-12 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col gap-8">
            ...
            <div className="mt-8">
              {/* Enquiry Button - Fixed Anchor Tag */}
              <a
                href={`https://wa.me/919840031124?text=${encodeURIComponent(`Hi I am interested in ${product.name}`)}`}
                target="_blank"
                rel="noopener noreferrer"
                className="w-full bg-[#C89B3C] text-white py-6 rounded-[24px] font-black text-xl flex items-center justify-center gap-4 transition-all duration-300 hover:bg-[#25D366] hover:-translate-y-1 hover:shadow-xl hover:shadow-green-500/20 shadow-lg shadow-[#C89B3C]/20"
              >
                <svg 
                  viewBox="0 0 24 24" 
                  width="28" 
