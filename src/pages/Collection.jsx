...
const Collection = () => {
  ...
  return (
    ...
    >
      <div className="container" style={{ width: '100% !important', maxWidth: '100% !important', padding: '0 40px' }}>
        ...
        <div className="collection-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '40px' }}>
